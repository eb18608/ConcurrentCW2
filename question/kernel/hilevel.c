...
void scheduleSVC( ctx_t* ctx  ) {
  ...
  // if (executing->pid == procTab[ readyProc-1 ].pid){
  //   dispatch( ctx, &procTab[ readyProc -1 ], &procTab[ 0 ]);   // context switch P_3 to P_1

  //   procTab[ readyProc -1 ].status = STATUS_READY;             // update execution status P_3
  //   procTab[ 0 ].status = STATUS_EXECUTING;         // update execution status P_1
  // }
  // else{
  //   dispatch( ctx, &procTab[ executing->pid -1 ], &procTab[ executing->pid ]);   // context switch P_3 to P_1

  //   procTab[ executing->pid-1 ].status = STATUS_READY;             // update execution status P_3
  //   procTab[ executing->pid ].status = STATUS_EXECUTING;         // update execution status P_1
  // }
